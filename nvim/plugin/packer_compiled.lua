...
_G.packer_plugins = {
  ...
  ["gruvbox.nvim"] = {
    loaded = true,
    path = "/Users/Tommy/.local/share/nvim/site/pack/packer/start/gruvbox.nvim",
  ...
  ["nvim-tree.lua"] = {
    loaded = true,
    path = "/Users/Tommy/.local/share/nvim/site/pack/packer/start/nvim-tree.lua",
  ...
  vimtex = {
    loaded = true,
    path = "/Users/Tommy/.local/share/nvim/site/pack/packer/start/vimtex",
